          ...
          <div class="container">
            ...
            <div id="navbar" class="navbar-collapse collapse">
              <ul class="nav navbar-nav">
                ...
                <li class="active"><a href="userlist.php">Users</a></li>
				...
				foreach($stmt as $row)
				{
					if($row['type']=='User')
					{
						...
						if($row['status']=='Active')
							echo"<td><a href='statususer.php?id=".$row['id']."'>De-Activate Account</a></td>";
						elseif ($row['status']=='Denied')
							echo"<td><a href='statususer.php?id=".$row['id']."'>Activate Account</a></td>";
						if(($row['car_request']=='No')&&($row['car_alloted']=='No'))
							echo"<td><a href='deleteuser.php?id=".$row['id']."'>Delete Account</a></td>";
						if(($row['car_alloted']=='No')&&($row['car_request']=='Yes'))
						{
							echo"<td><a href='approve_car_request.php?id=".$row['id']."'>Approve Car Request</a></td>";
							echo"<td><a href='deny_car_request.php?id=".$row['id']."'>Deny Car Request</a></td>";
						}
						elseif($row['car_alloted']=='Yes')
						{
							echo"<td><a href='view_hired_details.php?id=".$row['id']."'>View Hired Car Details</a></td>";
							echo"<td><a href='return_car.php?id=".$row['id']."'>Return a Car</a></td>";
						}
						echo"</tr>";
						++$sno;
					}
