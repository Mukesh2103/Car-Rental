...
<html>	
	...
	<body style="background-image: url('images/pic04.jpg')">
		...
		?>
		<div class="container">
     	<form action="approve_car_request_save.php" method="post" class="form-signup" onsubmit="return validating()">
        ...
        <table align="center" width="150%">
			...
			<tr>
				<td colspan="2">
					<button class="btn btn-lg btn-primary btn-block" type="submit">Approve Car Hire Request</button>
				</td>
			</tr>
			<tr>
				<td colspan="2">
