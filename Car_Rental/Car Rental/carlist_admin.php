          ...
          <div class="container">
            ...
            <div id="navbar" class="navbar-collapse collapse">
              <ul class="nav navbar-nav">
                ...
                <li class="active"><a href="carlist_admin.php">Cars</a></li>
		...
		<table class="table table-striped" width="100%">
			...
			<?php
				...
				foreach($stmt as $row)
				{
					...
					if($row['no_cars']>0)
					{
						echo"<td><a href='editcars.php?id=".$row['id']."'>Edit Details</a></td>";
						echo"<td><a href='addcars.php?id=".$row['id']."'>Add Cars</a></td>";
						echo"<td><a href='removecars.php?id=".$row['id']."'>Remove Cars</a></td>";
						if($row['no_cars']==$row['free_cars'])
							echo"<td><a href='deletecars.php?id=".$row['id']."'>Remove Car Model and All Cars</a></td></tr>";
						else
					...
					else
					{
						...
						echo"<td><a href='addcars.php?id=".$row['id']."'>Add Cars</a></td></tr>";
						echo"<td><a href='deletecars.php?id=".$row['id']."'>Remove Car Model and All Cars</a></td></tr>";
					}
					++$sno;
				}
