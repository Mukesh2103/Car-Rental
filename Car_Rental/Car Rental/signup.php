...
<html>
  ...
  <body style="background-image: url('images/pic04.jpg')">
    ...
    <div class="container">
      <form action="signupsave.php" method="post" class="form-signup" onsubmit="return validating()">
			...
			<?php
				if(isset($_REQUEST['check']))
				{
					if($_REQUEST['check']=='Y')
					{
						...
						echo"<tr><td colspan='2'><a class='btn btn-lg btn-success btn-block' href='Index.html'>Click here to go to Home Page</a></td></tr>";
					}
				}
			?>
		</table>
