        ...
        <div class="item active">
          ...
          <div class="container">
            <div class="carousel-caption">
              	<h1 style="color:grey;">Welcome Admin</h1>
            </div>
          </div>
        </div>
        <div class="item">
          ...
          <div class="container">
            <div class="carousel-caption">
              ...
              <p><a class="btn btn-lg btn-primary" href="car_register.php" role="button">Register a Car</a></p>
            </div>
          </div>
        </div>
        <div class="item">
          ...
          <div class="container">
            <div class="carousel-caption">
              ...
              <p><a class="btn btn-lg btn-primary" href="addAccount.php" role="button">Create Account</a></p>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="container marketing">
      ...
      <div class="row">
        <div class="col-lg-4">
          ...
          <p><a class="btn btn-default" href="carlist_admin.php" role="button">View details &raquo;</a></p>
        </div><!-- /.col-lg-4 -->
        <div class="col-lg-4">
          ...
          <p><a class="btn btn-default" href="userlist.php" role="button">View details &raquo;</a></p>
        </div><!-- /.col-lg-4 -->
        <div class="col-lg-4">
          <img class="img-circle" src="images/download (8).png" alt="Generic placeholder image" style="width: 140px; height: 140px;">
          <h2>Employees</h2>
          <p>View List of all Employees and Activate/Deactivate Account of Employees</p>
          <p><a class="btn btn-default" href="employees.php" role="button">View details &raquo;</a></p>
        </div><!-- /.col-lg-4 -->
      </div><!-- /.row -->
