    ...
    <div id="myCarousel" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner" role="listbox">
        <div class="item active">
          ...
          <div class="container">
            <div class="carousel-caption">
              <h1 style="color:grey;">We provide YOU the best services.</h1>
              <p></p>
        ...
        <div class="item">
          ...
          <div class="container">
            <div class="carousel-caption">
              <h1>Its YOU that's important.</h1>
              <p>Create Account in our Company.</p>
        ...
        <div class="item">
          ...
          <div class="container">
            <div class="carousel-caption">
              ...
              <p>Hire a Car from our Company.</p>
              <p><a class="btn btn-lg btn-primary" href="carlist.php" role="button">Hire a Car</a></p>
